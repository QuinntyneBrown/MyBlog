...
namespace MyBlog.Server.Services
{
    ...
    {
        private static volatile MyBlog.Server.Services.MemoryCache current = null;
        ObjectCache cache = System.Runtime.Caching.MemoryCache.Default;

        public static MyBlog.Server.Services.MemoryCache Current
        {
            get
            {
                if (current == null)
                    current = new MyBlog.Server.Services.MemoryCache();
                return current;
            }
        }
